...
The `[1]` tells us the index of the first item in the row is 1.
...
Both of these are examples of *character-vectors*, i.e. a vector in which each element itself is a character-string. We can access individual elements of a vector by using the `[` operator.
